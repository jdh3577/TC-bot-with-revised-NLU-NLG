...
if __name__ == "__main__":
    ...
    parser.add_argument('--agt', dest='agt', default=1, type=int, help='Select an agent: 0 for a command line input, 1-6 for rule based agents')
